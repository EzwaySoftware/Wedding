...
const realSlideCount = slides.children.length - 2; // karena ada clone di awal & akhir
...
slides.addEventListener("transitionend", () => {
  // ... looping logic kamu di sini ...

  updateDots(currentSlide); // ← tambahkan ini
});